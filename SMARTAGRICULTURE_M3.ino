...
void readSendData()
{
  ...
  float t = ((adc1 / 4095.0 * 5.0) - 0.3) * 100.0;
  float h = map(adc0, air_value, water_value, moisture_0, moisture_100); 
   Serial.print("Soil temperature = ");
  Serial.println(t);
  Serial.print("Soil moisture = ");
  Serial.println(h);
  Blynk.virtualWrite(V2, String(t,1)); delay(25);        // Отправка данных на сервер Blynk
  Blynk.virtualWrite(V3, String(h,1)); delay(25);         // Отправка данных на сервер Blynk
}
